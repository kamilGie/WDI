...
from szablon125 import Zadanie_125

TESTY_ISTNIEJA = False  # po napisaniu testow zmienic na true
...
class Testy125(unittest.TestCase):
...
def odpalTesty():
    ...
    suite = unittest.TestLoader().loadTestsFromTestCase(Testy125)
