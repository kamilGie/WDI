...
# jakoliczbęzapisanąwsystemiedwójkowymodługościN bitów.StałaN jestrzędu103.Proszęzaimplemen-
...
if __name__ == "__main__":
    from testy128 import Testy128

    Zadanie_128()
    # Testy128.StworzTesty([Zadanie_128])
