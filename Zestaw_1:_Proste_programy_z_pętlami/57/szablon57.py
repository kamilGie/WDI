...
# liczbąpierwszą.Naprzykład:13jestliczbąiloczynowo-pierwsząwsystemiedziesiętnym,bo1∗3=316jest
# liczbą iloczynowo-pierwszą w systemie trójkowym, bo 16=121 ,1∗2∗1=2 W liczbie naturalnej możemy
# (3)
...
if __name__ == "__main__":
    from testy57 import StworzTesty

    Zadanie_57()
    # StworzTesty([Zadanie_57])
