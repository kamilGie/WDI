...
# jemytak,ażusuniemywszystkiecyfryliczbyX.Następniesumujemywszystkiepowstałewtensposóbliczby,
# włączającliczbęX.Naprzykład,jeżeliwybraliśmyX=1234towkolejnychkrokachotrzymamyodpowiednio
...
if __name__ == "__main__":
    from testy47 import Testy47

    Zadanie_47()
    # Testy47.StworzTesty([Zadanie_47])
