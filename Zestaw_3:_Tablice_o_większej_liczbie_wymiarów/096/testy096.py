...
from szablon096 import ratio_check_in_tab
...
class testy(unittest.TestCase):
    ...
    def test_Nr09_ratio_check_in_tab_argumenty_tablica(self):
        self.assertEqual(
            ratio_check_in_tab([[-3, -2, -1], [-1, -1, -1], [-1, -1, -1]]),
            1.6666666666666667,
        )

    def test_Nr10_ratio_check_in_tab_argumenty_tablica(self):
        self.assertEqual(
            ratio_check_in_tab([[5, -10, 15], [20, -25, 30], [-5, 5, -5]]), 6.0
        )

    def test_Nr11_ratio_check_in_tab_argumenty_tablica(self):
        self.assertEqual(
            ratio_check_in_tab([[-10, -20, -30], [-5, -10, -15], [-1, -2, -1]]), 11.5
        )

    def test_Nr12_ratio_check_in_tab_argumenty_tablica(self):
        self.assertEqual(
            ratio_check_in_tab([[10, -50, 30], [5, 15, 25], [2, -4, 6]]), 15.25
        )

    def test_Nr13_ratio_check_in_tab_argumenty_tablica(self):
        self.assertEqual(ratio_check_in_tab([[0, -1, 0], [2, 0, 3], [4, -2, 0]]), 3.0)
