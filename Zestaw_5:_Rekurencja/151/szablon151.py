...
# obranegocelu(np.narożnika)królniemożewykonaćruchu,którypowodujeoddaleniegoodcelu.Danajest
...
if __name__ == "__main__":
    from testy151 import Testy151

    Zadanie_151()
    # Testy151.StworzTesty([Zadanie_151])
