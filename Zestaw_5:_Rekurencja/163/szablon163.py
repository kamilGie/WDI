...
# wierawspółrzędneNpunktówleżącychnapłaszczyźnie.Punktyposiadająjednostkowąmasę.Proszęnapisać
# funkcję,którasprawdzaczyistniejeniepustypodzbiórnpunktów,gdzien¡koraznjestwielokrotnościąliczby
...
if __name__ == "__main__":
    from testy163 import Testy163

    Zadanie_163()
    # Testy163.StworzTesty([Zadanie_163])
